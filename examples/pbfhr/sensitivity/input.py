...
cp_fuel = (
    random.gauss(1818.0, 1818 * 0.05) * units.joule / units.kg / units.kelvin
)  # [J/kg/K]
...
cp_cool = (
    random.gauss(2415.78, 2415.78 * 0.05) * units.joule / (units.kg * units.kelvin)
)
...
h_cool_rd = (
    random.gauss(4700.0, 4700.0 * 0.05) * units.watt / units.kelvin / units.meter ** 2
)
