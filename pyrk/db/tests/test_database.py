...
class DatabaseTest(unittest.TestCase):
    ...
    def test_add_group(self):
        self.a.add_group(
            groupname="test_group", grouptitle="Test Group", path_to_group="/"
        )
    ...
    def test_register_recorder(self):
        self.a.register_recorder("metadata", "sim_info", dictfunc, timeseries=True)
    ...
    def test_set_up_tables(self):
        ...
        for t in tables:
            assert_true(t["groupname"] in ["th", "metadata", "neutronics"])
            assert_true(
                t["tablename"]
                in [
                    "th_params",
    ...
    def test_set_up_groups(self):
        ...
        for g in groups:
            assert_true(g["groupname"] in ["th", "metadata", "neutronics"])
